...
const registriraj = async () => {
  ...
  try {
    const result = await createUserWithEmailAndPassword(auth, email.value, lozinka.value)
...
<template>
  <section class="card form">
    ...
    <div class="form-row"><label>Prezime</label><input v-model="prezime" /></div>
    <div class="form-row"><label>E-mail</label><input v-model="email" type="email" /></div>
    <div class="form-row"><label>Telefon</label><input v-model="telefon" /></div>
    <div class="form-row"><label>Lozinka</label><input v-model="lozinka" type="password" /></div>
    <div class="form-row"><label>Potvrda lozinke</label><input v-model="potvrda" type="password" /></div>
    ...
    <p class="muted">Već imaš račun? <router-link to="/prijava">Prijavi se</router-link></p>
  </section>
</template>
